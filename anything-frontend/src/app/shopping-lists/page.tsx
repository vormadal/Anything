    ...
    <div className="container mx-auto px-4 py-4 max-w-4xl">
      ...
      {hasActiveLists && (
        ...
        >
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden divide-y divide-gray-100 dark:divide-gray-700">
              {lists.map((list) => (
