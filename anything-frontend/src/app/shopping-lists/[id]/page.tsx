        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
          ...
          {showCompleteButton && (
            <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-center justify-between">
              ...
              >
                {completeList.isPending ? "Completing..." : "Mark Rest as Complete"}
              </Button>
            </div>
          )}
          ...
          {items && items.length > 0 && items.every((i) => i.isChecked) && (
            <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg flex items-center justify-between">
