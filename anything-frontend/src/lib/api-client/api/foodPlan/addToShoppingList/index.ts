...
// @ts-ignore
import { createHttpValidationProblemDetailsFromDiscriminatorValue, serializeAddFoodPlanToShoppingListRequest, type AddFoodPlanToShoppingListRequest, type HttpValidationProblemDetails } from '../../../models/index';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/food-plan/add-to-shopping-list
 */
 ...
 */
export const AddToShoppingListRequestBuilderUriTemplate = "{+baseurl}/api/food-plan/add-to-shopping-list";
/**
