...
// @ts-ignore
import { createHttpValidationProblemDetailsFromDiscriminatorValue, createLocationFromDiscriminatorValue, serializeCreateLocationRequest, serializeLocation, type CreateLocationRequest, type HttpValidationProblemDetails, type Location } from '../../models/index';
// @ts-ignore
...
export interface LocationsRequestBuilder extends BaseRequestBuilder<LocationsRequestBuilder> {
     ...
     */
     post(body: CreateLocationRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<Location | undefined>;
    /**
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
