...
// @ts-ignore
import { createHttpValidationProblemDetailsFromDiscriminatorValue, createRecipeStepFromDiscriminatorValue, serializeCreateRecipeStepRequest, type CreateRecipeStepRequest, type HttpValidationProblemDetails, type RecipeStep } from '../../../../models/index';
// @ts-ignore
...
export interface StepsRequestBuilder extends BaseRequestBuilder<StepsRequestBuilder> {
     ...
     */
     post(body: CreateRecipeStepRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ArrayBuffer | undefined>;
    /**
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
