 ...
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 * @returns {EventsTicketResponse}
 */
// @ts-ignore
export function createEventsTicketResponseFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoEventsTicketResponse;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
...
/**
 * The deserialization information for the current model
 * @param EventsTicketResponse The instance to deserialize into.
 * @returns {Record<string, (node: ParseNode) => void>}
 */
// @ts-ignore
export function deserializeIntoEventsTicketResponse(eventsTicketResponse: Partial<EventsTicketResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "ticket": n => { eventsTicketResponse.ticket = n.getStringValue(); },
    }
}
/**
 * The deserialization information for the current model
...
export interface EventsTicketResponse extends Parsable {
    /**
     * The ticket property
     */
    ticket?: string | null;
...
/**
 * Serializes information the current object
 * @param EventsTicketResponse The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeEventsTicketResponse(writer: SerializationWriter, eventsTicketResponse: Partial<EventsTicketResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!eventsTicketResponse || isSerializingDerivedType) { return; }
    writer.writeStringValue("ticket", eventsTicketResponse.ticket);
}
/**
 * Serializes information the current object
